...
export const ProjectsData: ProjectType[] = [
	...
	},
	{
		...
		description:
			"Портфолио инвесторов где можно посмотреть их улсуги и их проекты.",
		link: "",
	...
	},
	{
		...
		description:
			"Сайт где находится информация о всех учебных центрах города с описанием, ценами и отзывами.",
		link: "",
		stack: "ReactJS, Ant Design, i18next",
		photos: [
			{ id: 1, link: chd1 },
	...
	},
	{
		...
		description:
			"Сайт с кабинетом для электронного документооборота в Узбекистане. Я улучшал дизайн, адаптивность и UI проекта.",
	...
	},
	{
		...
		description:
			"Сайт аутсорсинговой компании на котором можно было ознакомиться с их услугами. Написан на HTML для улучшения SEO.",
	...
	},
	{
		...
		description:
			"Сайт для IT ACADEMY, где пользователи могли видеть информацию о курсах, почитать блог и познакомиться с историей академии. С нуля до продакшена за 1 месяц. Команда: я и один backend.",
	...
	},
	{
		...
		description:
			"Это интернет магазин, где пользователи могли покупать товары или создавать свои магазины и продавать свои товары. С нуля до MVP за 1 месяц. Команда: 2 frontend, 2 backend.",
		link: "",
	...
	},
	{
		...
		description:
			"FinAlley - платформа для торговли криптовалютой. Разрабатывал новый функционал, улучшал старый. Также с командой переписывали проекты на TypeScript. Улучшали свою UI библиотеку. В перспективах было закончить разработку платформы которая помогала бы максимально быстро клиентам создовать свои криптобиржы. Команда: 2 frontend + тим.лид, 2 backend, тестировщик, дизайнер, ПМ.",
	...
	},
	{
		...
		description:
			"Проект позволял создавать свои сообщества, свои социальные сети с гибкой настройкой. Клиенту достаточно было настроить соц.сеть в админской панели не прибегая к изменению кода. Команда: 4 frontend, 4 backend, 1 iOS, 1 android, 2 тестировщика, ПМ",
	...
	},
	{
		...
		description:
			"Проектная работа для сената РУз и ООН. Платформа мониторинга имплементации стратегии достижения гендерного равенства в РУз. Был единственным frontend разработчиком. Разработка с нуля до MVP за 2 месяца. Пока проект приостановлен, идет согласование о продакшене с ООН. Команда: я, один backend разработчик и ПМ он же дизайнер.",
		link: "",
		stack:
			"Next, Redux-toolkit, TypeScript, Feature sliced design, RTK Query, i18next, Ant Design",
		photos: [
			{ id: 1, link: undp1 },
			{ id: 2, link: undp2 },
			{ id: 3, link: undp3 },
	...
	},
	{
		...
		description:
			"RnD платформа для создания проектов, для проектов можно создавать научно исследовательские работы, принимать заявки, открывать вакансии и стажировки, маркетплейс ресурсов (услуги, аренда оборудования, продажа датасетов), создание технических заделов и многое другое. Над разработкой всего этого я принимал участие + внедрение методологии FSD. С MVP до продакшена за 2 месяца. Команда: 2 frontend, тим.лид, тех.лид, 2 backend разработчика, ПМ и дизайнер.",
		link: "",
		stack:
			"React, Redux-toolkit, RTK Query, TypeScript, Feature sliced design, MUI",
		photos: [
			{ id: 1, link: rnd1 },
			{ id: 2, link: rnd2 },
			{ id: 3, link: rnd3 },
