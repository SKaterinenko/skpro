...
const Projects = memo(() => {
	...
	return (
		<div className="flex flex-col w-full min-h-screen justify-center items-center snap-center relative duration-1000">
			<div
				className="md:grid-cols-2 xl:grid-cols-3 grid grid-cols-1 gap-10"
				id="projects"
			>
