...
export const Skills = memo(() => (
	...
	>
		<div>
			<h2 className="font-bold lg:text-5xl text-2xl mb-5">
				Я Go + React Developer
			</h2>
			<p className="font-light lg:text-3xl text-xl mb-6">
				Для создания современных, высокоскоростных и адаптивных веб приложений,
				я использую такие технологии как:
			</p>
